...
def mock_prediction(input_data):
    ...
    """
    try:
        # Extract values from input data with defaults
        ...
        dti = input_data.get('DebtToIncomeRatio', [20])[0] if hasattr(input_data, 'get') else 20
        emp_length = input_data.get('EmploymentLength', [5])[0] if hasattr(input_data, 'get') else 5
        fico = input_data.get('FicoScore', [700])[0] if hasattr(input_data, 'get') else 700
